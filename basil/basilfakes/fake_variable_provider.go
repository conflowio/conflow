...
type FakeVariableProvider struct {
	...
	LookupVarStub        func(lookup basil.VariableLookUp) (interface{}, error)
	lookupVarMutex       sync.RWMutex
	lookupVarArgsForCall []struct {
		lookup basil.VariableLookUp
	}
...
func (fake *FakeVariableProvider) LookupVar(lookup basil.VariableLookUp) (interface{}, error) {
...
func (fake *FakeVariableProvider) LookupVarArgsForCall(i int) basil.VariableLookUp {
	fake.lookupVarMutex.RLock()
	defer fake.lookupVarMutex.RUnlock()
...
var _ basil.VariableProvider = new(FakeVariableProvider)
