...
func (fake *FakeNode) CreateContainer(arg1 *basil.EvalContext, arg2 basil.RuntimeConfig, arg3 basil.BlockContainer, arg4 interface{}, arg5 []basil.WaitGroup, arg6 bool) basil.JobContainer {
...
func (fake *FakeNode) CreateContainerCalls(stub func(*basil.EvalContext, basil.RuntimeConfig, basil.BlockContainer, interface{}, []basil.WaitGroup, bool) basil.JobContainer) {
	fake.createContainerMutex.Lock()
	defer fake.createContainerMutex.Unlock()
	fake.CreateContainerStub = stub
}

func (fake *FakeNode) CreateContainerArgsForCall(i int) (*basil.EvalContext, basil.RuntimeConfig, basil.BlockContainer, interface{}, []basil.WaitGroup, bool) {
	fake.createContainerMutex.RLock()
	defer fake.createContainerMutex.RUnlock()
