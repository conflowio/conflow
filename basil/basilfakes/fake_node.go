...
func (fake *FakeNode) Dependencies() []basil.IdentifiableNode {
...
func (fake *FakeNode) DependenciesCalls(stub func() []basil.IdentifiableNode) {
	fake.dependenciesMutex.Lock()
	defer fake.dependenciesMutex.Unlock()
	fake.DependenciesStub = stub
}

func (fake *FakeNode) DependenciesReturns(result1 []basil.IdentifiableNode) {
	fake.dependenciesMutex.Lock()
	defer fake.dependenciesMutex.Unlock()
...
func (fake *FakeNode) DependenciesReturnsOnCall(i int, result1 []basil.IdentifiableNode) {
	fake.dependenciesMutex.Lock()
	defer fake.dependenciesMutex.Unlock()
	fake.DependenciesStub = nil
