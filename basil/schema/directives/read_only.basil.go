...
func (i ReadOnlyInterpreter) Params() map[basil.ID]basil.ParameterDescriptor {
	return nil
}

func (i ReadOnlyInterpreter) Blocks() map[basil.ID]basil.BlockDescriptor {
	return nil
}

func (i ReadOnlyInterpreter) HasForeignID() bool {
	return false
}
...
func (i ReadOnlyInterpreter) EvalStage() basil.EvalStage {
	var nilBlock *ReadOnly
