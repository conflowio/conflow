...
func (i ValueInterpreter) Params() map[basil.ID]basil.ParameterDescriptor {
	return nil
}

func (i ValueInterpreter) Blocks() map[basil.ID]basil.BlockDescriptor {
	return nil
}

func (i ValueInterpreter) HasForeignID() bool {
	return false
}
...
func (i ValueInterpreter) EvalStage() basil.EvalStage {
	var nilBlock *Value
