...
func (i RequiredInterpreter) Params() map[basil.ID]basil.ParameterDescriptor {
	return nil
}

func (i RequiredInterpreter) Blocks() map[basil.ID]basil.BlockDescriptor {
	return nil
}

func (i RequiredInterpreter) HasForeignID() bool {
	return false
}
...
func (i RequiredInterpreter) EvalStage() basil.EvalStage {
	var nilBlock *Required
