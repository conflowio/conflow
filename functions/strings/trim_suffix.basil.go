...
// TrimSuffixInterpreter is the basil interpreter for the TrimSuffix function
...
func (i TrimSuffixInterpreter) Eval(ctx interface{}, node conflow.FunctionNode) (interface{}, parsley.Error) {
