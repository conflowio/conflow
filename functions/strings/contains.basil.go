...
// ContainsInterpreter is an AST node interpreter for the Contains function
type ContainsInterpreter struct{}

// StaticCheck runs a static analysis on the function parameters
func (i ContainsInterpreter) StaticCheck(ctx interface{}, node basil.FunctionNode) (string, parsley.Error) {
