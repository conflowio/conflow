...
var _ = Describe("StructTag", func() {
	...
	DescribeTable("it evaluates the input correctly",
		...
		test.TableEntry("key_1", map[basil.ID]interface{}{"key_1": true}),
		...
		test.TableEntry("key_1,key_2=4", map[basil.ID]interface{}{"key_1": true, "key_2": int64(4)}),
	...
	DescribeTable("it returns a parse error",
		...
		test.TableEntry(`key_1=1,,key_2=2`, errors.New("was expecting parameter name or parameter name and value pair at testfile:1:9")),
	)
