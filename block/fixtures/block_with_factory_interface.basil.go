...
func (f *BlockWithFactoryInterfaceFactory) CreateBlock(parentCtx interface{}) (basil.Block, interface{}, parsley.Error) {
...
func (f *BlockWithFactoryInterfaceFactory) EvalBlock(ctx interface{}, stage string, res basil.Block) parsley.Error {
	var err parsley.Error
