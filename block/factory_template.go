...
func (f *{{$root.Name}}Factory) CreateBlock(parentCtx interface{}) (basil.Block, interface{}, parsley.Error) {
	...
	{{ if .HasForeignID }}
	idRegistry := parentCtx.(basil.IDRegistryAware).GetIDRegistry()
...
func (f *{{$root.Name}}Factory) EvalBlock(ctx interface{}, stage string, res basil.Block) parsley.Error {
	var err parsley.Error
