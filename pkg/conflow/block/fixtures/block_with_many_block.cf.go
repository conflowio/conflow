...
func init() {
	schema.Register(&schema.Object{
		Metadata: schema.Metadata{
			...
			ID: "github.com/conflowio/conflow/pkg/conflow/block/fixtures.BlockWithManyBlock",
		},
...
func (i BlockWithManyBlockInterpreter) Schema() schema.Schema {
	s, _ := schema.Get("github.com/conflowio/conflow/pkg/conflow/block/fixtures.BlockWithManyBlock")
	return s
}
