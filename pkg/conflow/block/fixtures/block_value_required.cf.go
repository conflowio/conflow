...
func init() {
	schema.Register(&schema.Object{
		Metadata: schema.Metadata{
			...
			ID: "github.com/conflowio/conflow/pkg/conflow/block/fixtures.BlockValueRequired",
		},
...
func (i BlockValueRequiredInterpreter) Schema() schema.Schema {
	s, _ := schema.Get("github.com/conflowio/conflow/pkg/conflow/block/fixtures.BlockValueRequired")
	return s
}
