...
func init() {
	schema.Register(&schema.Object{
		Metadata: schema.Metadata{
			...
			ID: "github.com/conflowio/conflow/pkg/openapi.OpenAPI",
		},
		...
		Properties: map[string]schema.Schema{
			...
			"paths": &schema.Map{
				AdditionalProperties: &schema.Reference{
					Nullable: true,
					Ref:      "github.com/conflowio/conflow/pkg/openapi.PathItem",
				},
			},
...
func (i OpenAPIInterpreter) Schema() schema.Schema {
	s, _ := schema.Get("github.com/conflowio/conflow/pkg/openapi.OpenAPI")
	return s
}
