...
import (
	...
	"github.com/conflowio/conflow/pkg/schema/schemafakes"
)

const testStructTypeFQTN = "github.com/conflowio/conflow/pkg/internal/testhelper.CustomStruct"
	...
	When("registering a new format", func() {
		...
		When("it's a default type", func() {
			...
			It("should be used for the given type", func() {
				source := `
					import "github.com/conflowio/conflow/pkg/internal/testhelper"
					// @block "configuration"
					type Foo struct {
