...
func init() {
	schema.Register(&schema.Object{
		Metadata: schema.Metadata{
			...
			ID: "github.com/conflowio/conflow/pkg/schema/directives.Dependency",
		},
		ParameterNames: map[string]string{"Name": "name"},
...
func (i DependencyInterpreter) Schema() schema.Schema {
	s, _ := schema.Get("github.com/conflowio/conflow/pkg/schema/directives.Dependency")
	return s
}
