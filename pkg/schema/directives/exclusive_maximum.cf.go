...
func init() {
	schema.Register(&schema.Object{
		Metadata: schema.Metadata{
			...
			ID: "github.com/conflowio/conflow/pkg/schema/directives.ExclusiveMaximum",
		},
...
func (i ExclusiveMaximumInterpreter) Schema() schema.Schema {
	s, _ := schema.Get("github.com/conflowio/conflow/pkg/schema/directives.ExclusiveMaximum")
	return s
}
