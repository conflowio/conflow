...
func init() {
	schema.Register(&schema.Object{
		Metadata: schema.Metadata{
			...
			ID: "github.com/conflowio/conflow/pkg/blocks.Gunzip",
		},
		Properties: map[string]schema.Schema{
			...
			"out": &schema.Reference{
				...
				Nullable: true,
				Ref:      "github.com/conflowio/conflow/pkg/blocks.Stream",
			},
		},
...
func (i GunzipInterpreter) Schema() schema.Schema {
	s, _ := schema.Get("github.com/conflowio/conflow/pkg/blocks.Gunzip")
	return s
}
