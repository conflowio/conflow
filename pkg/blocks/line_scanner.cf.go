...
func init() {
	schema.Register(&schema.Object{
		Metadata: schema.Metadata{
			...
			ID: "github.com/conflowio/conflow/pkg/blocks.LineScanner",
		},
		Properties: map[string]schema.Schema{
			...
			"line": &schema.Reference{
				...
				Nullable: true,
				Ref:      "github.com/conflowio/conflow/pkg/blocks.Line",
			},
		},
...
func (i LineScannerInterpreter) Schema() schema.Schema {
	s, _ := schema.Get("github.com/conflowio/conflow/pkg/blocks.LineScanner")
	return s
}
