...
var _ = Describe("GoType", func() {
	...
	It("should handle a user type", func() {
		...
		Expect(imports["github.com/conflowio/conflow/pkg/internal/testhelper"]).To(Equal("testhelper"))
	})
	...
	It("should handle a user type - another import with same name", func() {
		...
		Expect(imports["github.com/conflowio/conflow/pkg/internal/testhelper"]).To(Equal("testhelper2"))
	})
