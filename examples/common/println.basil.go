...
func (i PrintlnInterpreter) ProcessChannels(blockContainer basil.BlockContainer) {
}

func (i PrintlnInterpreter) CloseChannels(blockContainer basil.BlockContainer) {
}
