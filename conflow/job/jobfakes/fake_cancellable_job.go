...
func (fake *FakeCancellableJob) JobName() conflow.ID {
...
func (fake *FakeCancellableJob) JobNameCalls(stub func() conflow.ID) {
	fake.jobNameMutex.Lock()
	defer fake.jobNameMutex.Unlock()
	fake.JobNameStub = stub
}

func (fake *FakeCancellableJob) JobNameReturns(result1 conflow.ID) {
	fake.jobNameMutex.Lock()
	defer fake.jobNameMutex.Unlock()
...
func (fake *FakeCancellableJob) JobNameReturnsOnCall(i int, result1 conflow.ID) {
	fake.jobNameMutex.Lock()
	defer fake.jobNameMutex.Unlock()
	fake.JobNameStub = nil
