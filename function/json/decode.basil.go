...
// DecodeInterpreter is an AST node interpreter for the Decode function
type DecodeInterpreter struct{}

// StaticCheck runs a static analysis on the function parameters
func (i DecodeInterpreter) StaticCheck(ctx interface{}, node basil.FunctionNode) (string, parsley.Error) {
