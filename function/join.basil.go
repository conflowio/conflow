...
// JoinInterpreter is an AST node interpreter for the Join function
type JoinInterpreter struct{}

// StaticCheck runs a static analysis on the function parameters
func (i JoinInterpreter) StaticCheck(ctx interface{}, node basil.FunctionNode) (string, parsley.Error) {
...
func (i JoinInterpreter) Eval(ctx interface{}, node basil.FunctionNode) (interface{}, parsley.Error) {
	...
	arg0, err := variable.NodeStringArrayValue(arguments[0], ctx)
	if err != nil {
		return nil, err
	}
