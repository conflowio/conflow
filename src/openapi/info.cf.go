	...
	schema.Register(&schema.Object{
		...
		Properties: map[string]schema.Schema{
			"contact": &schema.Reference{
				Nullable: true,
				Ref:      "github.com/conflowio/conflow/src/openapi.Contact",
			},
			"description": &schema.String{},
			"license": &schema.Reference{
				Nullable: true,
				Ref:      "github.com/conflowio/conflow/src/openapi.License",
			},
...
func (i InfoInterpreter) Schema() schema.Schema {
	s, _ := schema.Get("github.com/conflowio/conflow/src/openapi.Info")
	return s
}
