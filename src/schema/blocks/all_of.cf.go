...
func init() {
	schema.Register(&schema.Object{
		Metadata: schema.Metadata{
			...
			ID: "github.com/conflowio/conflow/src/schema/blocks.AllOf",
		},
		FieldNames:        map[string]string{"allOf": "Schemas"},
		JSONPropertyNames: map[string]string{"schema": "allOf"},
...
func (i AllOfInterpreter) Schema() schema.Schema {
	s, _ := schema.Get("github.com/conflowio/conflow/src/schema/blocks.AllOf")
	return s
}
