...
var dependencyTypes = map[string]string{
	DependencyBlockPublisher: "github.com/conflowio/conflow/src/conflow.BlockPublisher",
	DependencyJobScheduler:   "github.com/conflowio/conflow/src/conflow.JobScheduler",
	DependencyLogger:         "github.com/conflowio/conflow/src/conflow.Logger",
