...
func init() {
	schema.Register(&schema.Object{
		Metadata: schema.Metadata{
			...
			ID:          "github.com/conflowio/conflow/src/conflow/block/fixtures.BlockWithOneBlock",
		},
...
func (i BlockWithOneBlockInterpreter) Schema() schema.Schema {
	s, _ := schema.Get("github.com/conflowio/conflow/src/conflow/block/fixtures.BlockWithOneBlock")
	return s
}
